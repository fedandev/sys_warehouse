        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('menus.store') }}" method="POST">
                ...
                <div class="form-group @if($errors->has('menu_descripcion')) has-error @endif">
                    ...
                    <input type="text" id="menu_descripcion-field" name="menu_descripcion" class="form-control" value="{{ old("menu_descripcion") }}"/>
                    ...
                    <input type="text" id="menu_posicion-field" name="menu_posicion" class="form-control" value="{{ old("menu_posicion") }}"/>
                    ...
                    <input type="text" id="menu_habilitado-field" name="menu_habilitado" class="form-control" value="{{ old("menu_habilitado") }}"/>
                    ...
                    <input type="text" id="menu_url-field" name="menu_url" class="form-control" value="{{ old("menu_url") }}"/>
                    ...
                    <input type="text" id="menu_icono-field" name="menu_icono" class="form-control" value="{{ old("menu_icono") }}"/>
                    ...
                    <input type="text" id="menu_formulario-field" name="menu_formulario" class="form-control" value="{{ old("menu_formulario") }}"/>
                    ...
                    <input type="text" id="menu_padre_id-field" name="menu_padre_id" class="form-control" value="{{ old("menu_padre_id") }}"/>
