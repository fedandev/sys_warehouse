(function( $ ){
    ...
    function __changeHandler( e ) {
        ...
        if (!isChecked) {
            ...
            $('#categoria_padre-field').value("");
            
        }
        
        if (isChecked) {
            $('input[type="checkbox"]').not(currentTarget).prop('checked', false); 
            $('#categoria_padre-field').val(currentTarget.attr('value'));
        }       
