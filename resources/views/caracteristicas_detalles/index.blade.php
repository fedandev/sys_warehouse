                        ...
                        <div class="row">
                            <div class="col-xl-12">                                
                                <table id="dt_table" class="table table-bordered table-hover table-striped w-100 table-sm" >
                                    ...
                                    <tbody>
                                        @foreach($caracteristicas_detalles as $caracteristica)   
                                        <tr>
                                            <td>{{ $caracteristica->id }} </td> 
                                            <td>{{ $caracteristica->caracteristica_detalle_nombre }}</td>
                                            <td>{{ $caracteristica->Caracteristica->caracteristica_nombre }}</td>                                         
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>                     
                ...
                buttons: [                        
                    {
                        ...
                        action: function ( e, dt, node, config ) {
                                    ...
                                    if(data){
                                        var id = data[0];
                                        var url = "{{ secure_url('caracteristicas_detalles') }}";
                                        bootbox.confirm({
                                            title: "Eliminar",
                    ...
                    {                           
                        ...
                        action: function ( e, dt, node, config ) {
                                    ...
                                    if(data){
                                        var id = data[0];
                                        var url = "{{ secure_url('caracteristicas_detalles') }}" + "/" + id + "/edit";
                                        window.location.href = url;    
                                    }
                    ...
                    },
                    {
                        ...
                        action: function ( e, dt, node, config ) {
                                    ...
                                    window.location.href = "{{ secure_url('caracteristicas_detalles/create') }}";                                    
                                }
                    }
