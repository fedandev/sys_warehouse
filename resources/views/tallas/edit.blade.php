        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('tallas.update', $talla->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('talla_descripcion')) has-error @endif">
                    ...
                    <input type="text" id="talla_descripcion-field" name="talla_descripcion" class="form-control" value="{{ is_null(old("talla_descripcion")) ? $talla->talla_descripcion : old("talla_descripcion") }}"/>
