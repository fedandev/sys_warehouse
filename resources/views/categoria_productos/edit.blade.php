...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> Categoria_productos / Edit #{{$categoria_producto->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('categoria_productos.update', $categoria_producto->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('categoria_producto_posicion')) has-error @endif">
                    ...
                    <input type="text" id="categoria_producto_posicion-field" name="categoria_producto_posicion" class="form-control" value="{{ is_null(old("categoria_producto_posicion")) ? $categoria_producto->categoria_producto_posicion : old("categoria_producto_posicion") }}"/>
                    ...
                    <input type="text" id="fk_categoria_id-field" name="fk_categoria_id" class="form-control" value="{{ is_null(old("fk_categoria_id")) ? $categoria_producto->fk_categoria_id : old("fk_categoria_id") }}"/>
                    ...
                    <input type="text" id="fk_producto_id-field" name="fk_producto_id" class="form-control" value="{{ is_null(old("fk_producto_id")) ? $categoria_producto->fk_producto_id : old("fk_producto_id") }}"/>
