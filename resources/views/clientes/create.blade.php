        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('clientes.store') }}" method="POST">
                ...
                <div class="form-group @if($errors->has('cliente_ruc')) has-error @endif">
                    ...
                    <input type="text" id="cliente_ruc-field" name="cliente_ruc" class="form-control" value="{{ old("cliente_ruc") }}"/>
                    ...
                    <input type="text" id="cliente_cedula-field" name="cliente_cedula" class="form-control" value="{{ old("cliente_cedula") }}"/>
                    ...
                    <input type="text" id="cliente_nombre-field" name="cliente_nombre" class="form-control" value="{{ old("cliente_nombre") }}"/>
                    ...
                    <input type="text" id="cliente_apellido-field" name="cliente_apellido" class="form-control" value="{{ old("cliente_apellido") }}"/>
                    ...
                    <input type="text" id="cliente_direccion-field" name="cliente_direccion" class="form-control" value="{{ old("cliente_direccion") }}"/>
                    ...
                    <input type="text" id="cliente_telefono1-field" name="cliente_telefono1" class="form-control" value="{{ old("cliente_telefono1") }}"/>
                    ...
                    <input type="text" id="cliente_telefono2-field" name="cliente_telefono2" class="form-control" value="{{ old("cliente_telefono2") }}"/>
                    ...
                    <input type="text" id="cliente_calle-field" name="cliente_calle" class="form-control" value="{{ old("cliente_calle") }}"/>
