...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-plus"></i> Rubros / Create </h1>
    </div>
@endsection
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('rubros.store') }}" method="POST">
                ...
                <div class="form-group @if($errors->has('rubro_nombre')) has-error @endif">
                    ...
                    <input type="text" id="rubro_nombre-field" name="rubro_nombre" class="form-control" value="{{ old("rubro_nombre") }}"/>
                    ...
                    <input type="text" id="rubro_descripcion-field" name="rubro_descripcion" class="form-control" value="{{ old("rubro_descripcion") }}"/>
