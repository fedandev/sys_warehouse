    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2> Grupos de Caracteristícas</h2>                     
                </div>
                ...
                buttons: [                        
                    {
                        ...
                        action: function ( e, dt, node, config ) {
                                    ...
                                    if(data){
                                        var id = data[0];
                                        var url = "{{ secure_url('grupos_caracteristicas') }}";
                                        bootbox.confirm({
                                            title: "Eliminar",
                    ...
                    {                           
                        ...
                        action: function ( e, dt, node, config ) {
                                    ...
                                    if(data){
                                        var id = data[0];
                                        var url = "{{ secure_url('grupos_caracteristicas') }}" + "/" + id + "/edit";
                                        window.location.href = url;    
                                    }
                    ...
                    },
                    {
                        ...
                        action: function ( e, dt, node, config ) {
                                    ...
                                    window.location.href = "{{ secure_url('grupos_caracteristicas/create') }}";                                    
                                }
                    }
